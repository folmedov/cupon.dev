...
class CuponExtension extends \Twig_Extension {
    ...
    public function getFilters() {
        return array(
            'mostrar_como_lista' => 
                new \Twig_Filter_Method($this, 'mostrarComoLista', array('is_safe' => array('html'))), 
            'cuenta_atras' => 
                new \Twig_Filter_Method($this, 'cuentaAtras', array('is_safe' => array('html'))), 
        );
    }
            ...
            <script type="text/javascript">
                function muestraCuentaAtras(){
                    ...
                    if (falta < 0) {
                        ...
                        cuentaAtras = (horas < 10 ? '0' + horas : horas)
                            + 'h '
